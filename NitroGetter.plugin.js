 ...
 * @source https://raw.githubusercontent.com/Sn8ow/PluginLary/main/PluginLary.js?token=ATIKYCS6XHFLAICZXWWYF3TAONVM6
 * @updateUrl https://raw.githubusercontent.com/Sn8ow/PluginLary/main/PluginLary.js?token=ATIKYCS6XHFLAICZXWWYF3TAONVM6
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
    const config = {
        "info": {
            ...
            "version": "1.0.6",
            "description": "Unlock all screensharing modes, and use cross-server emotes & gif emotes, Discord wide! (You CANNOT upload 100MB files though. :/ Sorry)",
            "github": "https://github.com/Sn8ow/NitroGetter",
            "twitter": "https://twitter.com/8owSn"
        },
        "main": "NitroGetter.plugin.js"
    };

    return !global.PluginLary ? class {
        constructor() {
            this._config = config;
        }
        getName() {
        ...
        load() {
            BdApi.showConfirmationModal("Library Missing", `The library plugin needed for ${config.info.name} is missing. Please click Download Now to install it.`, {
                ...
                cancelText: "Cancel",
                onConfirm: () => {
                    require("request").get("https://raw.githubusercontent.com/Sn8ow/PluginLary/main/PluginLary.js?token=ATIKYCS6XHFLAICZXWWYF3TAONVM6", async (error, response, body) => {
                        if (error) return require("electron").shell.openExternal("https://raw.githubusercontent.com/Sn8ow/PluginLary/main/PluginLary.js?token=ATIKYCS6XHFLAICZXWWYF3TAONVM6");
    ...
    })(global.PluginLary.buildPlugin(config));
})();
/*@end@*/